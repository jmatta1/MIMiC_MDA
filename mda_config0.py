...
CONFIG["Chain Directory"] = "./fits0/chains/"  # complete
...
CONFIG["Start Pts a3"] = [0.05, 0.10, 0.15]  # complete
CONFIG["Start Pts a4"] = [0.05, 0.15]  # complete
CONFIG["Start Pts a5"] = [0.05, 0.15]  # complete
CONFIG["Start Pts a6"] = [0.05]  # complete
CONFIG["Start Pts a7"] = [0.05]  # complete
...
CONFIG["Burn-in Points"] = 50  # complete
# NOTES:
