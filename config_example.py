...
# this file has the data as follows, each row is the data for 1 excitation
# energy, and has the following format
# ex_energy (MeV), angle, cs, cs_error, angle, cs, cs_err, ...
# for as many angle and cross-sections sets as there are at a given energy
